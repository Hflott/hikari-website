...
export default function Icon({ name, size = 18, className, style }: IconProps) {
  ...
  switch (name) {
    ...
    case "tv":       return <svg {...p}><rect x="2" y="4" width="20" height="14" rx="2"/><polyline points="8 22 16 22"/><line x1="12" y1="18" x2="12" y2="22"/></svg>;
    case "remote":   return <svg {...p}><rect x="6" y="2" width="12" height="20" rx="2"/><circle cx="12" cy="9" r="3"/><line x1="12" y1="14" x2="12" y2="18"/></svg>;
    ...
    case "list":     return <svg {...p}><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><circle cx="3.5" cy="6" r="1"/><circle cx="3.5" cy="12" r="1"/><circle cx="3.5" cy="18" r="1"/></svg>;
    ...
    case "captions": return <svg {...p}><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M7 15s1 1 2.5 1 2.5-1 2.5-1"/><path d="M14 15s1 1 2.5 1 2.5-1 2.5-1"/></svg>;
    ...
    case "discord":  return <svg {...p}><circle cx="9" cy="12" r="1"/><circle cx="15" cy="12" r="1"/><path d="M7.5 7.2c3.5-1 5.5-1 9 0"/><path d="M7 16.8c3.5 1 6.5 1 10 0"/><path d="m15.5 17.5 1 2c4-1 5.5-2.5 5.5-2.5 0-7-3-9.5-3-9.5l-3 1"/><path d="m8.5 17.5-1 2c-4-1-5.5-2.5-5.5-2.5 0-7 3-9.5 3-9.5l3 1"/></svg>;
    ...
    case "cast":     return <svg {...p}><path d="M2 16.1A5 5 0 0 1 5.9 20M2 12.05A9 9 0 0 1 9.95 20M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6"/><line x1="2" y1="20" x2="2.01" y2="20"/></svg>;
    case "menu":     return <svg {...p}><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>;
    case "calendar": return <svg {...p}><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="16" y1="2" x2="16" y2="6"/></svg>;
    ...
    case "mic":      return <svg {...p}><rect x="9" y="2" width="6" height="12" rx="3"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/></svg>;
